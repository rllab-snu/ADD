...
parser.add_argument(
    ...
    type=str2bool,
    default=False,
    help="use generative model to generate envs",
)

parser.add_argument(
    "--generator_model_path",
    type=str,
    default="diffusion_human_feedback/log/minigrid_60_uniform/model300000.pt",
...
parser.add_argument(
    ...
    type=str2bool,
    default=False,
    help="use regret-guided sampling using tutor networks",
)
...
parser.add_argument(
    ...
    default="diff_from_target",
    help="metric to estimate regret",
)

parser.add_argument(
    "--regret_guidance_weight",
    type=float,
    default=1.0,
    help="control the guidance weight of the regret-guided sampling",
)

parser.add_argument("--num_tutor", type=int, default=1, help="number of tutor networks")

parser.add_argument(
    "--tutor_update_iteration",
    type=int,
    default=5,
    help="number of iteration (sample different t) for one episode result",
)
...
parser.add_argument(
    ...
    type=int,
    default=1600,
    help="size of buffer. buffer is used to stabilize the training of tutor networks",
)
...
parser.add_argument(
    ...
    type=int,
    default=128,
    help="size of batch while training tutor networks",
)
parser.add_argument("--tutor_lr", type=float, default=3e-4, help="tutor learning rate")
parser.add_argument(
    "--tutor_weight_decay",
    type=float,
    default=0.05,
    help="tutor weight decay for regularization",
)
...
parser.add_argument(
    ...
    type=float,
    default=0.1,
    help="temperature of logsumexp used for estimating the maximum categorical value",
)
...
parser.add_argument(
    ...
    type=float,
    default=0.1,
    help="probability threshold to decide value at risk (VaR)",
)

parser.add_argument(
    "--return_add_noise_std",
    type=float,
    default=0.01,
    help="std of noise which is added to the true returns to form a categorical distribution",
)
...
parser.add_argument(
    ...
    type=int,
    default=0,
    help="Save parameters of environments every this many updates.",
)
parser.add_argument(
    "--env_save_batch_size",
    type=int,
    default=32,
    help="Number of training environments to save each env_save_interval.",
)
